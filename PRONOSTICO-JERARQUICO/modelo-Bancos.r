...
plot(ts.Competidor1,
     col = "blue", ylim = c(
          min(c(ts.Competidor1, ts.Competidor2)),
...
legend("topright", legend = c(
     ...
     "Competidor9", "Competidor10"
), col = c("blue", "red", "green", "grey", "yellow", "pink", "orange", "black", "brown", "gold"), lty = 1)
...
plot(Forecast.Competidor1,
     main = "Competidor1 Forecasting",
...
plot(Forecast.Competidor2,
     main = "Competidor2 Forecasting",
     ylab = "Competidor1 Volume"
)
####
#### Competidor3
...
plot(Forecast.Competidor3,
     main = "Competidor3 Forecasting",
     ylab = "Competidor1 Volume"
)
...
plot(Forecast.Competidor4,
     main = "Competidor4 Forecasting",
     ylab = "Competidor1 Volume"
)
...
plot(Forecast.Competidor5,
     main = "Competidor5 Forecasting",
     ylab = "Competidor1 Volume"
)
...
plot(Forecast.Competidor6,
     main = "Competidor6 Forecasting",
     ylab = "Competidor1 Volume"
)
...
plot(Forecast.Competidor7,
     main = "Competidor7 Forecasting",
     ylab = "Competidor1 Volume"
)
...
plot(Forecast.Competidor8,
     main = "Competidor8 Forecasting",
     ylab = "Competidor1 Volume"
)
...
plot(Forecast.Competidor9,
     main = "Competidor9 Forecasting",
     ylab = "Competidor1 Volume"
)
...
plot(Forecast.Competidor10,
     main = "Competidor10 Forecasting",
     ylab = "Competidor1 Volume"
)
####
